...
{
    settings.Version = "v1";
    settings.Title = "Bootcamp.Web API";
...
// NSwage.MsBuild + adding automation config in Bootcamp.Web.csproj makes this part of the build step (updates to API will be handled automatically)
app.UseOpenApi();
app.UseSwaggerUi3();
